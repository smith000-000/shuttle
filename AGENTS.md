...
- track major implementation work as long-lived mega-epic worklists in `inprocess/P#.md`
- amend the relevant `inprocess/P#.md` file in place for scope, sequencing, defects, regressions, and acceptance status instead of spawning extra scratch planning files
- archive retired mega-epic trackers under `completed/`
